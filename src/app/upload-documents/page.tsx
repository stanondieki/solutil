...
export default function UploadDocumentsPage() {
  ...
  const [documents, setDocuments] = useState<DocumentState>({
    nationalId: { file: null, uploaded: false, verified: false },
    businessLicense: { file: null, uploaded: false, verified: false },
    certificate: { file: null, uploaded: false, verified: false }
  })
