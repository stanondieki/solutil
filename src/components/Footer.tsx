        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link href="/services" className="hover:text-white transition-colors">Carpentry</Link></li>
              <li><Link href="/services" className="hover:text-white transition-colors">Painting</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link href="/booking" className="hover:text-white transition-colors">Book Service</Link></li>
